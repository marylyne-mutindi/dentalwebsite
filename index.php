    ...
    <body>
      ...
      <div class="banner_section">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <h1 class="banner_taital">Marylyne dental check up</h1>
              <h1 class="routine_taital">Your Routine Checkup</h1>
              <p class="lorem_text">It is a long established fact that a reader will be distracted by the readable content of a page when look Many desktop publishing packages and </p>
      ...
      <div class="services_section layout_padding">
        <div class="container">
          <p class="smile_text">Let us brighten your smile!</p>
          <h1 class="services_text">Explore Dental Care Services</h1>
              ...
              <div class="col-sm-12 col-lg-9">
                <div class="icons_main">
                  <div class="left_main">
                    ...
                    <h2 class="dental_text">Dental Implants</h2>
                    <p class="many_text">There are many variations of passages of Loreable, but the by injected humour,</p>
                  </div>
                  <div class="middle_main">
                    <div class="icon_1"><img src="images/icon-2.png"></div>
                    <h2 class="dental_text">Cosmetic Dentistry</h2>
                    <p class="many_text">There are many variations of passages of Loreable, but the by injected humour,</p>
                  </div>
                  <div class="right_main">
                    <div class="icon_1"><img src="images/icon-3.png"></div>
                    <h2 class="dental_text">Teeth Whitening</h2>
                    <p class="many_text">There are many variations of passages of Loreable, but the by injected humour,</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-12 col-lg-9">
                <div class="icons_main">
                  <div class="left_main">
                    ...
                    <h2 class="dental_text">Root Canal Therapy</h2>
                    <p class="many_text">There are many variations of passages of Loreable, but the by injected humour,</p>
                  </div>
                  <div class="middle_main">
                    <div class="icon_1"><img src="images/icon-5.png"></div>
                    <h2 class="dental_text">Routine Checkup</h2>
                    <p class="many_text">There are many variations of passages of Loreable, but the by injected humour,</p>
                  </div>
                  <div class="right_main">
                    <div class="icon_1"><img src="images/icon-6.png"></div>
                    <h2 class="dental_text">Smile Enhanment</h2>
                    <p class="many_text">There are many variations of passages of Loreable, but the by injected humour,</p>
                  </div>
                </div>
      ...
      <div class="choose_section layout_padding">
        <div class="container">
          <h1 class="choose_text">Why Choose Us </h1>
          <p class="available_text">available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable</p>
        </div>
      </div>
      <!-- choose section end -->
